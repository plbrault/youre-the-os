...
* Python 3.13
  * Later versions are currently unsupported because of an issue with the version of pygame used by the project. If needed, use [pyenv](https://github.com/pyenv/pyenv) to install Python 3.13 without impacting your system globally.
