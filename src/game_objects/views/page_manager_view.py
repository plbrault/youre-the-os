...
class PageManagerView(Drawable):
    def __init__(self, page_manager):
        ...
        self._pages_in_ram_text_surface = FONT_PRIMARY_18.render('Memory Pages in RAM :', False, Color.WHITE)
        self._pages_in_swap_space_text_surface = FONT_PRIMARY_18.render('Memory Pages on Disk :', False, Color.WHITE)        
