...
FONT_PRIMARY_SMALL = pygame.font.Font(path.join('assets', 'VT323-Regular.ttf'), 12) 
...
FOND_SECONDARY_SMALL = pygame.font.Font(path.join('assets', 'VictorMono-Regular.ttf'), 12)
